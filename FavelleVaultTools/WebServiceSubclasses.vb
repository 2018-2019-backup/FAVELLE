...
'Imports Autodesk.Connectivity.WebServices.DocumentExSvc
...
Namespace FavelleVaultTools
    ...
    'Public Class FixedLfCycDefListItem
    '    Public DispName As String
    '    Public IsRollback As Boolean
    '    Public FixedLfCycDef As FixedLfCycDef

    '    Public Sub New(ByVal fixedLfCycDef As FixedLfCycDef, ByVal isRollback As Boolean)
    '        Me.FixedLfCycDef = fixedLfCycDef
    '        Me.IsRollback = isRollback
    '    End Sub

    '    Public Sub New(ByVal fixedLfCycDef As FixedLfCycDef)
    '        Me.FixedLfCycDef = fixedLfCycDef
    '        Me.IsRollback = False
    '    End Sub
